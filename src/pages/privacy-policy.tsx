...
const PrivacyPolicy: React.FC = () => {
	return (
		<Layout>
			<div className="post">
				<h1>Privacy Policy for This Week in Godot</h1>

				<p>
					At This Week in Godot, accessible from https://thisweekingodot.com,
					one of our main priorities is the privacy of our visitors. This
					Privacy Policy document contains types of information that is
					collected and recorded by This Week in Godot and how we use it.
				</p>
				...
				<p>
					...
					shared and/or collect in This Week in Godot. This policy is not
				...
				<p>
					This Week in Godot follows a standard procedure of using log files.
				...
				<p>
					Like any other website, This Week in Godot uses 'cookies'. These
				...
				<p>
					...
					advertising partners of This Week in Godot.
				</p>

				<p>
					Third-party ad servers or ad networks uses technologies like cookies,
					JavaScript, or Web Beacons that are used in their respective
					advertisements and links that appear on This Week in Godot, which are
				...
				<p>
					Note that This Week in Godot has no access to or control over these
				...
				<p>
					This Week in Godot's Privacy Policy does not apply to other
				...
				<p>
					This Week in Godot does not knowingly collect any Personal
